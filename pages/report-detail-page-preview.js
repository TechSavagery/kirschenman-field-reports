...
const product = {
  ...
  sizes: [
    { name: 'Lot', description: 'Perfect for a reasonable amount of snacks.' },
    {
      name: 'Inspection Date',
      description: 'Enough room for a serious amount of snacks.',
    },
    { name: 'Brix', description: 'Perfect for a reasonable amount of snacks.' },
    {
      name: 'Size',
      description: 'Enough room for a serious amount of snacks.',
    },
    { name: 'Type', description: 'Perfect for a reasonable amount of snacks.' },
    {
      name: 'Appearance',
      description: 'Enough room for a serious amount of snacks.',
    },
