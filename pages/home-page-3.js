        ...
        <main>
                ...
                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                  <div className="lg:py-24">
                    ...
                    >
                      ...
                      <span className="ml-4 text-sm">Visit our grapes report dashboard!</span>
                    ...
                    Quality reports that capture the key details of the produce from the team at KEI. Data from field-to-phone to keep you up to date with our current offerings.   
                    </p>
                    <div className="mt-10 sm:mt-12">
                      <form action="#" className="sm:max-w-xl sm:mx-auto lg:mx-0">
                        ...
                        <p className="mt-3 text-sm text-gray-300 sm:mt-4">
                          Stay up to date with our latest reporting news and gain access to early access features.  By providing your email, you agree to
                          our{' '}
          ...
          <div className="relative bg-gray-50 pt-16 sm:pt-24 lg:pt-32">
            <div className="mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
              <div>
                <h2 className="text-base font-semibold tracking-wider text-lime uppercase">Live Field Data</h2>
                <p className="mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
                From our Fields to your Hands
                </p>
                <p className="mt-5 max-w-prose mx-auto text-xl text-gray-500">
                  Access data from any device and stay informed of current trends and availability for our produce. Send reports to colleagues seamlessly and create communications.
                </p>
              </div>
              <div className="mt-12 -mb-10 sm:-mb-24 lg:-mb-80">
                <img
                  ...
                  <blockquote>
                    <div>
                      ...
                      <p className="mt-6 text-2xl font-medium text-white">
                        We want to take you with us directly to the produce! Each report will have plenty of images and key data to easily measure the quality of the batch. 
                      </p>
                    </div>
                    <footer className="mt-6">
                      <p className="text-base font-medium text-white">Reporting Staff</p>
                      <p className="text-base font-medium text-cyan-100">Kirschenman Enterprises Inc </p>
                    </footer>
                  </blockquote>
                </div>
              </div>
          ...
          <div className="relative bg-gray-50 py-16 sm:py-24 lg:py-32">
            <div className="relative">
              <div className="text-center mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
                <h2 className="text-base font-semibold tracking-wider text-lime uppercase">Just In</h2>
                <p className="mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
                  Latest Reports
                </p>
                <p className="mt-5 mx-auto max-w-prose text-xl text-gray-500">
                  We are busy collecting data! Take a look at some of the fruit we are packaging up today. Get in touch with our sales department for more info! 
                </p>
              </div>
